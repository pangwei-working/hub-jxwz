...
# 提取标签内容
labels = list(dataset_df[0].values[:])
...
model = (BertForSequenceClassification
         .from_pretrained('../../../models/google-bert/bert-base-chinese', num_labels=2))
...
training_args = TrainingArguments(
    output_dir='./homework_results',              # 训练输出目录，用于保存模型和状态
    ...
    logging_steps=1000,                   # 每隔100步记录一次日志
...
if best_model_path:
    ...
    print("Best model saved to weights/bert.pt")
else:
