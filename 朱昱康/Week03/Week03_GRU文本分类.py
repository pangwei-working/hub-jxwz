...
class GRUClassifier(nn.Module):
    def __init__(self, vocab_size, embedding_dim, hidden_dim, output_dim, dropout=0.3, num_layers=2):
    ...
    def forward(self, x):
        ...
        out = self.dropout(hidden_state[-1])  # 取最后一层的hidden
        out = self.fc(out)
        return out
...
model = GRUClassifier(vocab_size, embedding_dim, hidden_dim, output_dim, dropout, num_layers)
