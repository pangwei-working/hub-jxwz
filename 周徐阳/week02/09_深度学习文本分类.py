...
print(f"label_to_index为:{label_to_index}")
...
class SimpleClassifier_02(nn.Module):
    """2层隐藏层"""

    def __init__(self, input_dim, hidden_dim, output_dim):
        super(SimpleClassifier_02, self).__init__()
        self.fc1 = nn.Linear(input_dim, hidden_dim)
        self.relu1 = nn.ReLU()
        self.fc2 = nn.Linear(hidden_dim, output_dim)
        self.relu2 = nn.ReLU()
...
print(f"output_dim为:{output_dim}")
# model = SimpleClassifier(vocab_size, hidden_dim, output_dim)
model = SimpleClassifier_02(vocab_size, hidden_dim, output_dim)
