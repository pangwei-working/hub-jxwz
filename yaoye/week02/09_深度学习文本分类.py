...
class SimpleClassifier(nn.Module):
    def __init__(self, input_dim, hidden_dim, hidden_dim2, output_dim): # 层的个数 和 验证集精度
        # 层初始化
...
model = SimpleClassifier(vocab_size, hidden_dim, hidden_dim2, output_dim) # 维度和精度有什么关系？
